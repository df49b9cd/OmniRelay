...
internal sealed class CompositeServerInterceptor : Interceptor
{
    private readonly GrpcServerInterceptorRegistry _registry;

    public CompositeServerInterceptor(GrpcServerInterceptorRegistry registry)
    {

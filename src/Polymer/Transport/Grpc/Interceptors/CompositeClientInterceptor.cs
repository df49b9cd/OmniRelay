...
namespace Polymer.Transport.Grpc.Interceptors;

internal sealed class CompositeClientInterceptor : Interceptor
{
    private readonly GrpcClientInterceptorRegistry _registry;
    private readonly string _service;

    public CompositeClientInterceptor(GrpcClientInterceptorRegistry registry, string service)
    {

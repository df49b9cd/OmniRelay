...
{
    private static readonly ActivitySource DefaultActivitySource = new("Polymer.Rpc");
    ...
    public ValueTask<Result<IStreamCall>> InvokeAsync(
        ...
        InvokeStreamCoreAsync(
            $"polymer.rpc.inbound.stream.{options.Direction.ToString().ToLowerInvariant()}",
            ActivityKind.Server,
            request,
            options,
            cancellationToken,
    ...
    public ValueTask<Result<IStreamCall>> InvokeAsync(
        ...
        InvokeStreamCoreAsync(
            $"polymer.rpc.outbound.stream.{options.Direction.ToString().ToLowerInvariant()}",
            ActivityKind.Client,
            request,
            options,
            cancellationToken,
    ...
    public ValueTask<Result<Response<ReadOnlyMemory<byte>>>> InvokeAsync(
        ...
        InvokeClientStreamInboundAsync(
            "polymer.rpc.inbound.client_stream",
            context,
            cancellationToken,
            next);
    ...
    public ValueTask<Result<IClientStreamTransportCall>> InvokeAsync(
        ...
        InvokeClientStreamOutboundAsync(
            "polymer.rpc.outbound.client_stream",
            requestMeta,
            cancellationToken,
            next);

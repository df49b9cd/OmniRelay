...
public sealed class PolymerProtobufGenerator
{
    ...
    private sealed class ProtoFileContext
    {
    ...
    private sealed class ServiceEmitter
    {
        ...
        public ServiceEmitter(ProtoFileContext fileContext, ServiceDescriptorProto service, Dictionary<string, TypeInfo> typeLookup)
        {
        ...
        public GeneratedFile Emit()
        {
            ...
            var className = $"{_service.Name}Polymer";

...
public sealed class HttpStatusMapperTests
{
    ...
    public void ToStatusCode_MapsExpectedValues(OmniRelayStatusCode statusCode, int expectedHttp)
    {
    ...
    public void FromStatusCode_MapsExpectedValues(int httpStatus, OmniRelayStatusCode expected)
    {
